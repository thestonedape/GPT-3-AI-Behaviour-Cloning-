...
st.markdown('This is an experiment of prompt designing by using GPT-3(a transformer model), a neural network trained and hosted by OpenAI.', unsafe_allow_html=False)
st.markdown('tips: Try to ask specific detaied questions, like "What is the meaning of "the" in "the meaning of life"?', unsafe_allow_html=False)
